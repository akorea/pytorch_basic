...
* 소스 코드
    ...
    | [8.notmnist_dataset.py](./8.notmnist_dataset.py) | http://yaroslavvb.com/upload/notMNIST/notMNIST_small.tar.gz  폴더의 notMNIST 파일을 다운로드 하여 train, test 데이터로 분류하고 dataloader 만들기(학습전 단계) |
## 9. 시각화
* TBD
